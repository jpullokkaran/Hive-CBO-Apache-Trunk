...
public class SqlFunctionConverter {
	...
	static Map<GenericUDF, SqlOperator> hiveToOptiq = new HashMap<GenericUDF, SqlOperator>();
	...
	public static SqlOperator getOptiqOperator(GenericUDF hiveUDF) {
		return hiveToOptiq.get(hiveUDF);
	}
	...
	private static void registerFunction(String name, SqlFunctionCategory cat) {
	...
	private static void registerFunction(String name, SqlOperator optiqFn) {
		...
		hiveToOptiq.put(hFn.getGenericUDF(), optiqFn);
	}
